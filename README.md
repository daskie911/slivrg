...
Пользователь выбирает способ оплаты (Stars или крипта)
После оплаты получает уникальную одноразовую invite-ссылку
При входе в канал ссылка автоматически отзывается
Планировщик следит за истечением подписок: отправляет напоминания и удаляет неоплативших пользователей
🏗 Архитектура
...
(Опционально) Crypto Bot Token (от @CryptoBot)
Локальный запуск
Bash
...
<p align="center"> Разработано <a href="https://github.com/daskie911">@daskie911</a> </p>
